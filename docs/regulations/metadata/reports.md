...
10. Если в отчете несколько наборов данных нужно давать понятные наименования наборов. Требования такие же как к [переменным](https://wiki.yandex.ru/homepage/reglament-razrabotki/oformlenie/#imena-metodov-i-ih-opisanie).
Неправильно:
```
ТаблИтоги1
ТаблИтоги2
...
НаборДанных2
```
11. [Не забывать учитывать RLS](https://wiki.yandex.ru/homepage/reglament-razrabotki/zaprosy/#uchityvat-rls-pri-napisanii-zaprosov)
